    ...
    <div className="flex flex-col lg:flex-row justify-between items-center mx-auto w-[70%] mt-10 relative">
      ...
      <div id="sliders" className="w-full lg:w-[40%] mt-8 lg:mt-0 lg:ml-6">
        <div 
          id="button" 
          onClick={printImage} 
          className="mt-4 px-4 py-2 bg-slate-600 sm:relative lg:absolute width-[25%] mt-[45px] ml-[3%] hover:bg-slate-700 text-white text-center mb-8 w-full lg:w-[25%] lg:left-0 rounded m-auto cursor-pointer"
        >
          Download Banner
        </div>
        <div className='mb-2'>
