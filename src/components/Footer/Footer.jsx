    ...
    <footer className="bg-white shadow dark:bg-gray-900">
        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div className="sm:flex sm:items-center sm:justify-between">
                ...
                <ul className="flex flex-wrap items-center mb-6 text-sm font-medium text-gray-500 sm:mb-0 dark:text-gray-400 pointer">
                    <Fade duration={750} cascade>
                    <li>
                        <a href="#" 
                        className="hover:text-gray-300 me-4 md:me-6">
                        Examples
                        </a>
                    </li>
                    <li>
            ...
            <span className="block text-sm lg:text-[0.6em] lg:my-4 text-gray-500 sm:text-center dark:text-slate-200 tracking-[2px]">© {year} <a href="https://matthewjlowe.com" className="hover:text-gray-400">Hang Your Banner</a>. All Rights Reserved.</span>
        </div>
    </footer>
